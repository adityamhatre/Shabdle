...
export const getClassName = (letter) => {
  ...
  const currentIndexInTry = parseInt(
    sessionStorage.getItem("currentIndexInTry")
  );
  ...
  setTimeout(() => {
    document
      ...
      [currentIndex].classList.remove("flip");
    document.getElementsByClassName("tile")[currentIndex].innerHTML =
      letter + document.getElementsByClassName("tile")[currentIndex].innerHTML;
  }, 400);
  ...
  document.getElementsByClassName("tile")[currentIndex].dataset.state =
    classToReturn;
...
export const deleteLetter = () => {
  ...
  document.getElementsByClassName("tile")[currentIndex - 1].innerHTML =
    guessRowMap[currentIndex - 1] || "";
