...
import './Key.css'
import { getClassName, submitWord, deleteLetter } from '../util/script';
...
export function Key(props) {
    ...
    if (props.children === 'del') {
        return <button className={'key large'} onClick={deletePressed}> <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
